...

{
  ...
  by-spec."ajv".">=4.10.0" =
    self.by-version."ajv"."4.11.3";
  by-version."ajv"."4.11.3" = self.buildNodePackage {
    name = "ajv-4.11.3";
    version = "4.11.3";
    bin = false;
    src = fetchurl {
  ...
  by-spec."ajv-keywords"."^1.0.0" =
    self.by-version."ajv-keywords"."1.5.1";
  by-version."ajv-keywords"."1.5.1" = self.buildNodePackage {
    name = "ajv-keywords-1.5.1";
    version = "1.5.1";
    bin = false;
    src = fetchurl {
  ...
  by-spec."callback-stream"."^1.0.2" =
    self.by-version."callback-stream"."1.1.0";
  by-version."callback-stream"."1.1.0" = self.buildNodePackage {
    name = "callback-stream-1.1.0";
    version = "1.1.0";
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/callback-stream/-/callback-stream-1.1.0.tgz";
      name = "callback-stream-1.1.0.tgz";
  ...
  by-version."del"."2.2.2" = self.buildNodePackage {
    ...
    deps = {
      ...
      "rimraf-2.6.0" = self.by-version."rimraf"."2.6.0";
    };
    optionalDependencies = {
    };
    peerDependencies = [];
  ...
  by-version."detox-node-service-auth-module"."0.0.1" = self.buildNodePackage {
    ...
    deps = {
      ...
      "urijs-1.18.7" = self.by-version."urijs"."1.18.7";
    };
    optionalDependencies = {
    };
    peerDependencies = [];
  ...
  by-version."eslint"."2.13.1" = self.buildNodePackage {
    ...
    deps = {
      ...
      "espree-3.4.0" = self.by-version."espree"."3.4.0";
      "estraverse-4.2.0" = self.by-version."estraverse"."4.2.0";
      "esutils-2.0.2" = self.by-version."esutils"."2.0.2";
      "file-entry-cache-1.3.1" = self.by-version."file-entry-cache"."1.3.1";
      "glob-7.1.1" = self.by-version."glob"."7.1.1";
      "globals-9.16.0" = self.by-version."globals"."9.16.0";
      "ignore-3.2.4" = self.by-version."ignore"."3.2.4";
  ...
  by-spec."espree"."^3.1.6" =
    self.by-version."espree"."3.4.0";
  by-version."espree"."3.4.0" = self.buildNodePackage {
    name = "espree-3.4.0";
    version = "3.4.0";
    bin = false;
    src = fetchurl {
  ...
  by-spec."glob-parent"."^3.0.0" =
    self.by-version."glob-parent"."3.1.0";
  by-version."glob-parent"."3.1.0" = self.buildNodePackage {
    name = "glob-parent-3.1.0";
    version = "3.1.0";
    bin = false;
    src = fetchurl {
    ...
    deps = {
      ...
      "path-dirname-1.0.2" = self.by-version."path-dirname"."1.0.2";
    };
    optionalDependencies = {
    };
    peerDependencies = [];
  ...
  by-spec."glob-stream"."^5.3.2" =
    self.by-version."glob-stream"."5.3.5";
  by-version."glob-stream"."5.3.5" = self.buildNodePackage {
    name = "glob-stream-5.3.5";
    version = "5.3.5";
    bin = false;
    src = fetchurl {
    ...
    deps = {
      ...
      "glob-parent-3.1.0" = self.by-version."glob-parent"."3.1.0";
  ...
  by-spec."globals"."^9.2.0" =
    self.by-version."globals"."9.16.0";
  by-version."globals"."9.16.0" = self.buildNodePackage {
    name = "globals-9.16.0";
    version = "9.16.0";
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/globals/-/globals-9.16.0.tgz";
      name = "globals-9.16.0.tgz";
  ...
  by-spec."help-me"."^1.0.0" =
    self.by-version."help-me"."1.0.1";
  by-version."help-me"."1.0.1" = self.buildNodePackage {
    name = "help-me-1.0.1";
    version = "1.0.1";
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/help-me/-/help-me-1.0.1.tgz";
      name = "help-me-1.0.1.tgz";
      sha1 = "b6893c8b0ed9d3c60db83560fa75b4d0097a8d5a";
    };
    deps = {
      "callback-stream-1.1.0" = self.by-version."callback-stream"."1.1.0";
      "glob-stream-5.3.5" = self.by-version."glob-stream"."5.3.5";
  ...
  by-spec."ignore"."^3.1.2" =
    self.by-version."ignore"."3.2.4";
  by-version."ignore"."3.2.4" = self.buildNodePackage {
    name = "ignore-3.2.4";
    version = "3.2.4";
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/ignore/-/ignore-3.2.4.tgz";
      name = "ignore-3.2.4.tgz";
  ...
  by-spec."is-extglob"."^2.1.0" =
    self.by-version."is-extglob"."2.1.1";
  by-version."is-extglob"."2.1.1" = self.buildNodePackage {
  ...
  by-version."is-glob"."3.1.0" = self.buildNodePackage {
    ...
    deps = {
      "is-extglob-2.1.1" = self.by-version."is-extglob"."2.1.1";
    };
    optionalDependencies = {
    };
    peerDependencies = [];
  ...
  by-spec."mockery"."^2.0.0" =
    self.by-version."mockery"."2.0.0";
  by-version."mockery"."2.0.0" = self.buildNodePackage {
    name = "mockery-2.0.0";
    version = "2.0.0";
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/mockery/-/mockery-2.0.0.tgz";
      name = "mockery-2.0.0.tgz";
      sha1 = "0569a11a1848461fdc347cf8cca2df2f3129bc03";
    };
    deps = {
    };
    optionalDependencies = {
  ...
  "mockery" = self.by-version."mockery"."2.0.0";
  by-spec."mqtt"."1.8.0" =
  ...
  by-version."mqtt"."1.8.0" = self.buildNodePackage {
    ...
    deps = {
      ...
      "mqtt-packet-3.4.8" = self.by-version."mqtt-packet"."3.4.8";
      "readable-stream-1.0.34" = self.by-version."readable-stream"."1.0.34";
      "reinterval-1.1.0" = self.by-version."reinterval"."1.1.0";
      "websocket-stream-3.3.3" = self.by-version."websocket-stream"."3.3.3";
      "xtend-4.0.1" = self.by-version."xtend"."4.0.1";
    };
    optionalDependencies = {
    };
  ...
  by-spec."mqtt"."^2.0.1" =
    self.by-version."mqtt"."2.4.0";
  by-version."mqtt"."2.4.0" = self.buildNodePackage {
    name = "mqtt-2.4.0";
    version = "2.4.0";
    bin = true;
    src = fetchurl {
      url = "https://registry.npmjs.org/mqtt/-/mqtt-2.4.0.tgz";
      name = "mqtt-2.4.0.tgz";
      sha1 = "0381594fc14095fd1f63ff8670b370f2073ee672";
    };
    deps = {
      "commist-1.0.0" = self.by-version."commist"."1.0.0";
      "concat-stream-1.6.0" = self.by-version."concat-stream"."1.6.0";
      "end-of-stream-1.1.0" = self.by-version."end-of-stream"."1.1.0";
      "help-me-1.0.1" = self.by-version."help-me"."1.0.1";
      "inherits-2.0.3" = self.by-version."inherits"."2.0.3";
      "minimist-1.2.0" = self.by-version."minimist"."1.2.0";
      "mqtt-packet-5.2.1" = self.by-version."mqtt-packet"."5.2.1";
      "readable-stream-2.2.2" = self.by-version."readable-stream"."2.2.2";
      "pump-1.0.2" = self.by-version."pump"."1.0.2";
      "reinterval-1.1.0" = self.by-version."reinterval"."1.1.0";
  ...
  by-spec."mqtt-packet"."^3.0.0" =
    self.by-version."mqtt-packet"."3.4.8";
  by-version."mqtt-packet"."3.4.8" = self.buildNodePackage {
    name = "mqtt-packet-3.4.8";
    version = "3.4.8";
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/mqtt-packet/-/mqtt-packet-3.4.8.tgz";
      name = "mqtt-packet-3.4.8.tgz";
      sha1 = "965774aa45952f16392f9accaac5d0bf511fa1a5";
    };
    deps = {
  ...
  by-spec."mqtt-packet"."^3.2.0" =
    self.by-version."mqtt-packet"."3.4.8";
  by-spec."mqtt-packet"."^5.0.0" =
    self.by-version."mqtt-packet"."5.2.1";
  by-version."mqtt-packet"."5.2.1" = self.buildNodePackage {
    name = "mqtt-packet-5.2.1";
    version = "5.2.1";
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/mqtt-packet/-/mqtt-packet-5.2.1.tgz";
      name = "mqtt-packet-5.2.1.tgz";
  ...
  by-spec."path-dirname"."^1.0.0" =
    self.by-version."path-dirname"."1.0.2";
  by-version."path-dirname"."1.0.2" = self.buildNodePackage {
    name = "path-dirname-1.0.2";
    version = "1.0.2";
    bin = false;
    src = fetchurl {
  ...
  by-spec."process-nextick-args"."^1.0.7" =
  ...
  by-spec."readable-stream"."> 1.0.0 < 3.0.0" =
  ...
  "rewire" = self.by-version."rewire"."2.5.2";
  by-spec."rimraf"."^2.2.8" =
    self.by-version."rimraf"."2.6.0";
  by-version."rimraf"."2.6.0" = self.buildNodePackage {
    name = "rimraf-2.6.0";
    version = "2.6.0";
    bin = true;
    src = fetchurl {
      url = "https://registry.npmjs.org/rimraf/-/rimraf-2.6.0.tgz";
      name = "rimraf-2.6.0.tgz";
      sha1 = "89b8a0fe432b9ff9ec9a925a00b6cdb3a91bbada";
    };
    deps = {
      "glob-7.1.1" = self.by-version."glob"."7.1.1";
    };
  ...
  by-version."table"."3.8.3" = self.buildNodePackage {
    ...
    deps = {
      "ajv-4.11.3" = self.by-version."ajv"."4.11.3";
      "ajv-keywords-1.5.1" = self.by-version."ajv-keywords"."1.5.1";
      "chalk-1.1.3" = self.by-version."chalk"."1.1.3";
      "lodash-4.17.4" = self.by-version."lodash"."4.17.4";
  ...
  by-spec."urijs"."^1.18.1" =
    self.by-version."urijs"."1.18.7";
  by-version."urijs"."1.18.7" = self.buildNodePackage {
    name = "urijs-1.18.7";
    version = "1.18.7";
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/urijs/-/urijs-1.18.7.tgz";
      name = "urijs-1.18.7.tgz";
      sha1 = "613ee4194452fe66b872d62468946df93a941492";
    };
    deps = {
    };
    optionalDependencies = {
  ...
  "urijs" = self.by-version."urijs"."1.18.7";
  ...
  by-spec."websocket-stream"."^3.0.1" =
    self.by-version."websocket-stream"."3.3.3";
  by-version."websocket-stream"."3.3.3" = self.buildNodePackage {
    name = "websocket-stream-3.3.3";
    version = "3.3.3";
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/websocket-stream/-/websocket-stream-3.3.3.tgz";
      name = "websocket-stream-3.3.3.tgz";
  ...
  by-spec."websocket-stream"."^3.3.2" =
    self.by-version."websocket-stream"."3.3.3";
  ...
  by-spec."winston"."^2.2.0" =
    self.by-version."winston"."2.3.1";
  by-version."winston"."2.3.1" = self.buildNodePackage {
    name = "winston-2.3.1";
    version = "2.3.1";
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/winston/-/winston-2.3.1.tgz";
      name = "winston-2.3.1.tgz";
  ...
  by-spec."winston-mqtt"."git+ssh://git@github.com/dstil/winston-mqtt.git#df8dfd7" =
    self.by-version."winston-mqtt"."1.0.0";
  by-version."winston-mqtt"."1.0.0" = self.buildNodePackage {
    name = "winston-mqtt-1.0.0";
    version = "1.0.0";
    bin = false;
    src = fetchgit {
      url = "ssh://git@github.com/dstil/winston-mqtt.git";
      rev = "df8dfd724986e0e2a5d0551640c49e0810fd08ec";
      sha256 = "08cxb7a6qlfhzwd4g6898gka1iifb8bc61bnilhdcnnsyawa20dh";
    };
    deps = {
      "mqtt-2.4.0" = self.by-version."mqtt"."2.4.0";
      "winston-2.3.1" = self.by-version."winston"."2.3.1";
    };
    optionalDependencies = {
    };
    peerDependencies = [];
  ...
  "winston-mqtt" = self.by-version."winston-mqtt"."1.0.0";
